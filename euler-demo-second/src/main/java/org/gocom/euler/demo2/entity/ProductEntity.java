...
public class ProductEntity extends BaseEntity {
	...
	private List<InventoryEntity> inventoryEntities = new LinkedList<InventoryEntity>();
	...
	/**
	 * @return Returns the inventoryEntities.
	 */
	...
	/**
	 * @param inventoryEntities The inventoryEntities to set.
	 */
